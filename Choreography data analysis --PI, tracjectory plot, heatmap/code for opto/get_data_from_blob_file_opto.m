function [dat1,fields1,uname]=get_data_from_blob_file_opto(name_of_folder,ii,l)
% remember to check whether choreography results have the same length;
% if not try to run it in the student room
%this function will combine the data within the same big folder
dat.et = {}; dat.x= {}; dat.AN={}; dat.y ={}; dat.sp ={};
choredir=name_of_folder{l};
%% get filelist
